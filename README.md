# 골 때리는 그녀들 데이터 센터 - 모바일 앱

SBS 예능 '골 때리는 그녀들'의 경기 데이터, 선수 통계, 커뮤니티 기능을 제공하는 모바일 앱입니다.
...
이 앱은 별도의 백엔드 서버를 사용하지 않고, [골 때리는 그녀들 데이터 센터](https://www.gtndatacenter.com) 웹사이트의 API를 직접 호출합니다.
