...
export interface PenaltyShootoutDetailWithPlayers extends PenaltyShootoutDetail {
...
export type PlayerInput = Omit<Player, 'player_id' | 'created_at' | 'updated_at'>;
export type TeamInput = Omit<Team, 'team_id' | 'created_at' | 'updated_at'>;
export type SeasonInput = Omit<Season, 'season_id' | 'created_at' | 'updated_at'>;
export type TeamSeasonInput = Omit<TeamSeason, 'team_season_id' | 'created_at'>;
export type PlayerTeamHistoryInput = Omit<PlayerTeamHistory, 'history_id' | 'created_at'>;
export type MatchInput = Omit<Match, 'match_id'>;
export type PlayerMatchStatsInput = Omit<PlayerMatchStats, 'stat_id' | 'created_at' | 'updated_at'>;
export type PlayerSeasonStatsInput = Omit<
  PlayerSeasonStats,
  'stat_id' | 'created_at' | 'updated_at'
>;
export type TeamSeasonStatsInput = Omit<TeamSeasonStats, 'stat_id' | 'created_at' | 'updated_at'>;
export type StandingInput = Omit<Standing, 'standing_id' | 'created_at' | 'updated_at'>;
export type GoalInput = Omit<Goal, 'goal_id' | 'created_at' | 'updated_at'>;
export type AssistInput = Omit<Assist, 'assist_id' | 'created_at' | 'updated_at'>;
...
// 커뮤니티 기능 Input 타입들
export type CommunityPostInput = Omit<CommunityPost, 'post_id' | 'created_at' | 'updated_at'>;
export type PostCommentInput = Omit<PostComment, 'comment_id' | 'created_at' | 'updated_at'>;
...
export type CommunityEventInput = Omit<CommunityEvent, 'event_id' | 'created_at'>;
export type EventParticipationInput = Omit<
  EventParticipation,
  'participation_id' | 'participated_at'
>;
export type UserNotificationInput = Omit<UserNotification, 'notification_id' | 'created_at'>;

// Update types (all fields optional)
export type UserUpdate = Partial<Omit<User, 'user_id' | 'created_at' | 'updated_at'>>;
export type PlayerUpdate = Partial<Omit<Player, 'player_id' | 'created_at' | 'updated_at'>>;
...
export type PlayerTeamHistoryUpdate = Partial<Omit<PlayerTeamHistory, 'history_id'>>;
...
export type PlayerSeasonStatsUpdate = Partial<Omit<PlayerSeasonStats, 'stat_id'>>;
...
export type GoalUpdate = Partial<Omit<Goal, 'goal_id' | 'created_at' | 'updated_at'>>;
export type AssistUpdate = Partial<Omit<Assist, 'assist_id' | 'created_at' | 'updated_at'>>;
...
// 커뮤니티 기능 Update 타입들
export type CommunityPostUpdate = Partial<Omit<CommunityPost, 'post_id' | 'user_id'>>;
export type PostCommentUpdate = Partial<Omit<PostComment, 'comment_id' | 'post_id' | 'user_id'>>;
...
>;
export type UserNotificationUpdate = Partial<Omit<UserNotification, 'notification_id' | 'user_id'>>;
